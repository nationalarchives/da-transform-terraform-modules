...
resource "aws_lambda_function" "bagit_files_checksum_function" {
  image_uri     = "882876621099.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/te-files-checksum-validation:0.0.6"
  package_type  = "Image"
...
resource "aws_lambda_function" "run_judgments_parser" {
  image_uri = "882876621099.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/te-text-parser-step-function:0.0.10"
  package_type = "Image"
...
resource "aws_lambda_function" "editorial_integration" {
  image_uri = "882876621099.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/te-editorial-integration:0.0.9"
  package_type = "Image"
