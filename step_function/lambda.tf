...
resource "aws_lambda_function" "prepare_parser_input" {
  image_uri = "${var.account_id}.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/prepare-parser-input:${var.image_versions.tre_text_parser_step_function}"
  package_type = "Image"
...
resource "aws_lambda_function" "judgment_parser_lambda" {
  image_uri = "${var.account_id}.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/te-text-parser:${var.image_versions.tre_text_parser}"
  package_type = "Image"
...
resource "aws_lambda_function" "editorial_integration" {
  image_uri = "${var.account_id}.dkr.ecr.eu-west-2.amazonaws.com/lambda_functions/te-editorial-integration:${var.image_versions.tre_editorial_integration}"
  package_type = "Image"
